...
int zapisyService::zapiszProjekt(std::string projektID, std::string zapisywanyID, struct z1__zapiszProjektResponse &_param_1){
    ...
    bool zapisany=baza->szukajProjektStudenta(zapisywanyID,"3");
    std::cerr << "Zapisany: " << zapisany<< std::endl;
     if( baza->zapiszNaProjekt(projektID, zapisywanyID) ){
...
int zapisyService::zapiszTermin(std::string projektID, std::string zapisywanyID, struct z1__zapiszTerminResponse &_param_3){
 ...
 int zapisyService::dodajPrzedmiot(std::string importowanyPrzedmiot, z1__temat *projekt, struct z1__dodajPrzedmiotResponse &_param_8) {return 0;}

 int zapisyService::dodajProwadzacego(z1__prowadzacy *daneProwadzacego, struct z1__dodajProwadzacegoResponse &_param_9) {return 0;}
