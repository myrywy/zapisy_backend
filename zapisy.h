...
//  Forward declaration of class z1__opcja.
class z1__opcja;
...
/// Element "szczegoly" of XSD type "localhost/zapisy.wsdl":przedmiot.
    z1__przedmiot*                       szczegoly                      1;	///< Required element.
...
/// @brief "localhost/zapisy.wsdl":opcja is a complexType.
///
/// class z1__opcja operations:
/// - z1__opcja* soap_new_z1__opcja(soap*) allocate
/// - z1__opcja* soap_new_z1__opcja(soap*, int num) allocate array
/// - z1__opcja* soap_new_req_z1__opcja(soap*, ...) allocate, set required members
/// - z1__opcja* soap_new_set_z1__opcja(soap*, ...) allocate, set all public members
/// - z1__opcja::soap_default(soap*) reset members to default
/// - int soap_read_z1__opcja(soap*, z1__opcja*) deserialize from a stream
/// - int soap_write_z1__opcja(soap*, z1__opcja*) serialize to a stream
/// - z1__opcja* z1__opcja::soap_dup(soap*) returns deep copy of z1__opcja, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - z1__opcja::soap_del() deep deletes z1__opcja data members, use only after z1__opcja::soap_dup(NULL) (use soapcpp2 -Ed)
class z1__opcja
{ public:
/// Element "nazwa" of XSD type xs:string.
    std::string                          nazwa                          1;	///< Required element.
/// Element "wartosc" of XSD type xs:string.
    std::string                          wartosc                        1;	///< Required element.
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
@section zapisy_operations Operations of Binding "zapisy"
  ...
  - @ref z1__usunWszystkieTematy

  - @ref z1__usunWszystkieTerminy

  - @ref z1__usunTemat

  - @ref z1__usunTermin

  - @ref z1__importujProjekty

  - @ref z1__importujTerminy

  - @ref z1__importujStudentow

  - @ref z1__edytujStudenta
...
int z1__dodajPrzedmiot(
    z1__importowanyPrzedmiot*           przedmiot,	///< Input parameter
...
/// Operation response struct "z1__usunWszystkieTematyResponse" of operation "z1__usunWszystkieTematy".
struct z1__usunWszystkieTematyResponse
{
    z1__wynik                           rezultat;
};

/** Operation "z1__usunWszystkieTematy" of service binding "zapisy".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call_z1__usunWszystkieTematy(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap z1   service method-protocol:	usunWszystkieTematy SOAP
//gsoap z1   service method-style:	usunWszystkieTematy rpc
//gsoap z1   service method-encoding:	usunWszystkieTematy literal
//gsoap z1   service method-action:	usunWszystkieTematy ""
//gsoap z1   service method-output-action:	usunWszystkieTematy Response
int z1__usunWszystkieTematy(
    z1__id                              ID,	///< Input parameter
    struct z1__usunWszystkieTematyResponse&	///< Output response struct parameter
);
...
/// Operation response struct "z1__usunWszystkieTerminyResponse" of operation "z1__usunWszystkieTerminy".
struct z1__usunWszystkieTerminyResponse
{
    z1__wynik                           rezultat;
};

/** Operation "z1__usunWszystkieTerminy" of service binding "zapisy".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call_z1__usunWszystkieTerminy(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap z1   service method-protocol:	usunWszystkieTerminy SOAP
//gsoap z1   service method-style:	usunWszystkieTerminy rpc
//gsoap z1   service method-encoding:	usunWszystkieTerminy literal
//gsoap z1   service method-action:	usunWszystkieTerminy ""
//gsoap z1   service method-output-action:	usunWszystkieTerminy Response
int z1__usunWszystkieTerminy(
    z1__id                              ID,	///< Input parameter
    struct z1__usunWszystkieTerminyResponse&	///< Output response struct parameter
);
...
/// Operation response struct "z1__usunTematResponse" of operation "z1__usunTemat".
struct z1__usunTematResponse
{
    z1__wynik                           rezultat;
};

/** Operation "z1__usunTemat" of service binding "zapisy".
...
//gsoap z1   service method-protocol:	usunTemat SOAP
//gsoap z1   service method-style:	usunTemat rpc
//gsoap z1   service method-encoding:	usunTemat literal
//gsoap z1   service method-action:	usunTemat ""
//gsoap z1   service method-output-action:	usunTemat Response
int z1__usunTemat(
    z1__id                              ID,	///< Input parameter
    struct z1__usunTematResponse       &	///< Output response struct parameter
);
...
/// Operation response struct "z1__usunTerminResponse" of operation "z1__usunTermin".
struct z1__usunTerminResponse
{
    z1__wynik                           rezultat;
};

/** Operation "z1__usunTermin" of service binding "zapisy".
...
//gsoap z1   service method-protocol:	usunTermin SOAP
//gsoap z1   service method-style:	usunTermin rpc
//gsoap z1   service method-encoding:	usunTermin literal
//gsoap z1   service method-action:	usunTermin ""
//gsoap z1   service method-output-action:	usunTermin Response
int z1__usunTermin(
    z1__id                              ID,	///< Input parameter
    struct z1__usunTerminResponse      &	///< Output response struct parameter
);
...
/// Operation response struct "z1__importujProjektyResponse" of operation "z1__importujProjekty".
struct z1__importujProjektyResponse
{
    z1__wynik                           rezultat;
};

/** Operation "z1__importujProjekty" of service binding "zapisy".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call_z1__importujProjekty(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap z1   service method-protocol:	importujProjekty SOAP
//gsoap z1   service method-style:	importujProjekty rpc
//gsoap z1   service method-encoding:	importujProjekty literal
//gsoap z1   service method-action:	importujProjekty ""
//gsoap z1   service method-output-action:	importujProjekty Response
int z1__importujProjekty(
    z1__id                              przedmiotId,	///< Input parameter
    z1__csv                             dane,	///< Input parameter
    struct z1__importujProjektyResponse&	///< Output response struct parameter
);
...
/// Operation response struct "z1__importujTerminyResponse" of operation "z1__importujTerminy".
struct z1__importujTerminyResponse
{
    z1__wynik                           rezultat;
};

/** Operation "z1__importujTerminy" of service binding "zapisy".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call_z1__importujTerminy(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap z1   service method-protocol:	importujTerminy SOAP
//gsoap z1   service method-style:	importujTerminy rpc
//gsoap z1   service method-encoding:	importujTerminy literal
//gsoap z1   service method-action:	importujTerminy ""
//gsoap z1   service method-output-action:	importujTerminy Response
int z1__importujTerminy(
    z1__id                              przedmiotId,	///< Input parameter
    z1__csv                             dane,	///< Input parameter
    struct z1__importujTerminyResponse &	///< Output response struct parameter
);
...
/// Operation response struct "z1__importujStudentowResponse" of operation "z1__importujStudentow".
struct z1__importujStudentowResponse
{
    z1__wynik                           rezultat;
};

/** Operation "z1__importujStudentow" of service binding "zapisy".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call_z1__importujStudentow(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap z1   service method-protocol:	importujStudentow SOAP
//gsoap z1   service method-style:	importujStudentow rpc
//gsoap z1   service method-encoding:	importujStudentow literal
//gsoap z1   service method-action:	importujStudentow ""
//gsoap z1   service method-output-action:	importujStudentow Response
int z1__importujStudentow(
    z1__id                              przedmiotId,	///< Input parameter
    z1__csv                             dane,	///< Input parameter
    struct z1__importujStudentowResponse&	///< Output response struct parameter
);
...
/// Operation response struct "z1__edytujStudentaResponse" of operation "z1__edytujStudenta".
struct z1__edytujStudentaResponse
{
    z1__wynik                           rezultat;
};

/** Operation "z1__edytujStudenta" of service binding "zapisy".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call_z1__edytujStudenta(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap z1   service method-protocol:	edytujStudenta SOAP
//gsoap z1   service method-style:	edytujStudenta rpc
//gsoap z1   service method-encoding:	edytujStudenta literal
//gsoap z1   service method-action:	edytujStudenta ""
//gsoap z1   service method-output-action:	edytujStudenta Response
int z1__edytujStudenta(
    z1__id                              studentId,	///< Input parameter
    z1__student*                        student,	///< Input parameter
    struct z1__edytujStudentaResponse  &	///< Output response struct parameter
);
...
/// Operation response struct "z1__zmienOpcjeResponse" of operation "z1__zmienOpcje".
struct z1__zmienOpcjeResponse
{
    z1__wynik                           rezultat;
};

/** Operation "z1__zmienOpcje" of service binding "zapisy".
...
//gsoap z1   service method-protocol:	zmienOpcje SOAP
//gsoap z1   service method-style:	zmienOpcje rpc
//gsoap z1   service method-encoding:	zmienOpcje literal
//gsoap z1   service method-action:	zmienOpcje ""
//gsoap z1   service method-output-action:	zmienOpcje Response
int z1__zmienOpcje(
    z1__opcja*                          opcja,	///< Input parameter
    struct z1__zmienOpcjeResponse      &	///< Output response struct parameter
);
